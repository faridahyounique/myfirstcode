    ...
    <div class="container_fluid">
        <div class="container">
            ...
            <table class="table table-hover">
                    ...
                    <tbody>
                        <?php 
                            $sql = "SELECT * FROM applicant_profile WHERE application_status='Rejected' ORDER BY surName ASC";
                            if($result= $conn->query($sql))
                            {
                                $i=0;
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="rejected_applicants.php?accept=<?=$id;?>"><button class="btn btn-success bg-info mt-1 mb-1 dropdown-item" name="accept">Accept</button></a></li>
                                                    <li><a href="rejected_applicants.php?reject=<?=$id;?>"><button class="btn btn-danger bg-danger mt-1 mb-1 dropdown-item" name="reject">Reject</button></a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>  
