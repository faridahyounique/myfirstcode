        ...
        <div class="container">
            ...
            <div>
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php 
                            $sql = "SELECT * FROM applicant_profile ORDER BY surName ASC";
                            if($result= $conn->query($sql))
                            {
                                $i=0;
                                    ...
                                    <tr>
                                        ...
                                        <?php 
                                            if($row['application_status']=='Accepted'){?>
                                                <td><span class="badge bg-success mt-3 ml-2 text-light"><?=$row['application_status'];?></span></td>
                                        <?php }
                                        ?>
                                        <?php 
                                            if($row['application_status']=='Rejected'){?>
                                                <td><span class="badge bg-danger mt-3 ml-2 text-light"><?=$row['application_status'];?></span></td>
                                        <?php }
                                        ?>
                                        <?php 
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="all_applicants.php?accept=<?=$id;?>"><button class="btn btn-success bg-info mt-1 mb-1 dropdown-item" name="accept">Accept</button></a></li>
                                                    <li><a href="all_applicants.php?reject=<?=$id;?>"><button class="btn btn-danger bg-danger mt-1 mb-1 dropdown-item" name="reject">Reject</button></a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>  
